...
export function Hero() {
  return (
    <section
      className="relative min-h-[88vh] bg-cover bg-center bg-no-scroll text-white overflow-hidden"
    ...
    >
      ...
      <div className="pointer-events-none absolute -right-32 -top-32 hidden md:block">
      ...
      <div className="relative z-10 container grid grid-cols-1 lg:grid-cols-5 gap-10 lg:gap-16 items-center py-16 md:py-24">
        ...
        <div className="lg:col-span-3">
          ...
          <h1 className="text-4xl font-bold leading-tight md:text-5xl md:leading-tight lg:text-6xl lg:leading-tight">
            Find home,{" "}
            <span className="text-emerald-300">not just</span>
            <br />a house.
          </h1>
          ...
          <p className="mt-4 max-w-md text-base text-white/75 leading-relaxed">
            ...
            <span className="text-white font-medium">12% annual yield.</span>
          </p>
        ...
        <div className="lg:col-span-2 hidden lg:flex justify-end relative">
          ...
          <div className="absolute -left-6 top-8 z-10 flex items-center gap-3 rounded-xl bg-white/95 backdrop-blur px-3 py-2.5 shadow-xl text-foreground max-w-[200px]">
            ...
            <div>
              <p className="text-xs font-semibold leading-tight">Lekki Phase 1</p>
          ...
          <div className="absolute -left-4 bottom-12 z-10 flex items-center gap-3 rounded-xl bg-white/95 backdrop-blur px-3 py-2.5 shadow-xl text-foreground max-w-[200px]">
            <div className="relative size-10 shrink-0 overflow-hidden rounded-lg">
              <Image
            ...
            <div>
              <p className="text-xs font-semibold leading-tight">Ikeja GRA</p>
          ...
          <Image
            ...
            width={480}
            height={520}
            className="w-auto h-auto max-h-[480px] object-contain drop-shadow-2xl"
            priority
          />
        </div>
      </div>
