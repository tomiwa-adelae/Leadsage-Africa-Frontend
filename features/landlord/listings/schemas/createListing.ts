...
.superRefine((data, ctx) => {
  ...
  if ((data.listingType === "shortlet" || data.listingType === "hotel-room") && !data.pricePerNight) {
    ctx.addIssue({ code: "custom", path: ["pricePerNight"], message: "Nightly price is required" })
  }
  if ((data.listingType === "shortlet" || data.listingType === "hotel-room") && !data.minimumNights) {
